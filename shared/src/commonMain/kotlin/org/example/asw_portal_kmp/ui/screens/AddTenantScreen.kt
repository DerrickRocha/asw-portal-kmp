...
fun AddTenantScreenContent(
    ...
    Scaffold(
        ...
        Column(
                    ...
                    if (state.domain.isNotBlank()) {
                        Row(
                            ...
                            Icon(
                                ...
                                contentDescription = "Domain availability",
                                modifier = Modifier.size(20.dp),
                                tint = if (state.isDomainAvailable)
            ...
            if (state.domain.isNotBlank() && state.domainError == null) {
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.Start,
                    verticalAlignment = Alignment.CenterVertically
                ) {
                    if (state.isCheckingDomain) {
                    ...
                    } else if (state.isDomainAvailable) {
                        Icon(
                    ...
                    } else if (state.isDomainChecked && !state.isDomainAvailable) {
                        Icon(
